...
const entries: Entry[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        You keep ownership of your original quote. By publishing it, you give us
        permission to display and share it on our platform.
      </p>
    ),
  },
];
...
export default function WriteGuidelinesPage() {
  ...
  console.log("accepted? :",user?.hasAcceptedCurrentGuidelines)
  const alreadyAccepted = !!user?.hasAcceptedCurrentGuidelines;
  ...
  async function handleAcceptGuidelines() {
    ...
    setSubmitError(null);
    try {
      const res = await fetch("http://localhost:3000/quote/accept-guideline", {
        method: "POST",
      ...
      if (!res.ok) {
        throw new Error("Couldn't save your acceptance. Please try again.");
      }

      router.push("/quote-editor");
    } catch (error: any) {
  ...
  function handleContinue() {
    // Already accepted a previous time — nothing to save, just go.
    router.push("/quote-editor");
  }
      ...
      <div className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="mb-14">
          ...
          <p
            ...
            style={{ color: "#9C9587" }}
          >
            Help us build a community where words inspire people — original,
        ...
        >
          ...
          >
            &ldquo;What you make today is proof of who you&apos;re
            becoming.&rdquo;
          </p>
        ...
        <div className="space-y-4">
          ...
          <section
            className="rounded-xl p-6 sm:p-7"
            style={{
              background: "rgba(185,139,62,0.08)",
          ...
          {/* Checklist / already-accepted gate */}
          {!user ? (
            ...
            >
              ...
              >
                You&apos;ve already agreed to these guidelines
              </h2>
              <p className="mt-3 text-[15px] leading-relaxed" style={{ color: "#B9B2A3" }}>
                No need to check everything again — you&apos;re clear to keep writing.
              </p>

              <button
                onClick={handleContinue}
                className="mt-6 w-full rounded-lg py-3 text-sm font-semibold tracking-wide transition"
            ...
            >
              ...
              <div className="mt-5 space-y-3">
                <Checkbox
                  ...
                  onChange={() =>
                    setChecks((c) => ({ ...c, original: !c.original }))
                  }
                />
                <Checkbox
                  ...
                  onChange={() =>
                    setChecks((c) => ({ ...c, reviewed: !c.reviewed }))
                  }
                />
                <Checkbox
                  ...
                  onChange={() =>
                    setChecks((c) => ({ ...c, guidelines: !c.guidelines }))
                  }
                />
              </div>
              ...
              {submitError && (
                <p className="mt-3 text-sm" style={{ color: "#D98A8A" }}>
                  {submitError}
                </p>
              )}
              ...
              >
                {submitting ? "Saving…" : "Continue to Quote Editor →"}
              </button>
            </section>
          )}
        </div>
        ...
        <p
          ...
          style={{ fontFamily: "var(--font-display)", color: "#6B6559" }}
        >
